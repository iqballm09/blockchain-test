...
ORG2_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/sl.com/users/Admin@sl.com/msp
ORG2_TLS_ROOTCERT=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/sl.com/users/Admin@sl.com/tls/ca.crt
...
# menambahkan peer co ke dalam channel
...
# menambahkan peer sl ke dalam channel
